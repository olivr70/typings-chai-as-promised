...
declare module '~chai/lib/Assertion' {
  ...
  export interface Assertion { // extends LanguageChains, NumericComparison, TypeComparison {
    ...
    xxx_chai_Assertion():void;
  }

  // Eventually does not have .then(), but PromisedAssertion have.
  export interface Eventually extends PromisedLanguageChains, PromisedNumericComparison, PromisedTypeComparison {
  ...
  export interface PromisedAssertion extends Eventually, PromisesAPlus.Thenable<any> {
  }

  export interface PromisedLanguageChains {
  ...
  export interface PromisedNumericComparison {
  ...
  export interface PromisedEqual {
    (value: any, message?: string): PromisedAssertion;
  }

  export interface PromisedProperty {
    (name: string, value?: any, message?: string): PromisedAssertion;
  }

  export interface PromisedOwnProperty {
    (name: string, message?: string): PromisedAssertion;
  }

  export interface PromisedLength extends PromisedLanguageChains, PromisedNumericComparison {
  ...
  export interface PromisedKeys {
    (...keys: string[]): PromisedAssertion;
    (keys: any[]): PromisedAssertion;
  }

  export interface PromisedThrow {
    (): PromisedAssertion;
  ...
  export interface PromisedMembers {
...
declare module 'chai-as-promised' {
  import { Utils } from 'chai';
  import { PromisesAPlus } from "promises-a-plus";

  export default function chaiAsPromised(chai: any, utils: Utils): void;
  
  interface ArgsTransformer {
    (args:any):any;
  }
  
  export var transferPromiseness:(assertion:PromisesAPlus.Thenable<any>,promise:any) => void;
  export var transformAsserterArgs:ArgsTransformer;
}
